...
async def readiness(request: Request) -> JSONResponse:
    ...
    inference_client = getattr(request.app.state, "inference_client", None)
    inference_ready = bool(inference_client is not None and await inference_client.is_ready())
    ...
    ready = workflow_ready and inference_ready and policies_loaded and not shutting_down
