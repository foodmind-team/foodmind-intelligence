...
class TestVerifierEdgeCases:
    ...
    def test_negative_start_rejected(self) -> None:
        ...
        result = ScheduleResult(
            ...
            makespan_minutes=5,
            intervals=(
                ScheduledInterval(task_id="t1", start_minute=-1, end_minute=4),
            ),
        )
...
class TestMultiDishIntegration:
    ...
    def test_passive_boiling_parallel(self) -> None:
        ...
        tasks = (
            ...
            _task("boil", duration=15, deps=(dep,), work_mode=WorkMode.PASSIVE, resources=(need_stove,), category="heating"),
