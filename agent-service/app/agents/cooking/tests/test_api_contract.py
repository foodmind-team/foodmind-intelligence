...
class TestOpenAPISchema:
    ...
    def test_openapi_includes_generate_endpoint(self, client: TestClient) -> None:
        ...
        assert "/internal/v1/agents/cooking-plan/generate" in paths, (
            "Generate endpoint missing from OpenAPI schema"
        )
    ...
    def test_openapi_includes_request_schema(self, client: TestClient) -> None:
        ...
        assert "GeneratePlanRequest" in schemas, (
            "GeneratePlanRequest schema missing from OpenAPI"
        )
