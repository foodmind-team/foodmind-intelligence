# =============================================================================
# 多轮确认对话节点（workflow/conversation_nodes）
# -----------------------------------------------------------------------------
# 把一次性 NEEDS_CONFIRMATION 终态升级为对话中间态：用户在 apply_confirmation
# 处挂起（LangGraph interrupt/断点），提交 answers 后经 Command(resume=...) 续接，
# 本节点校验、映射为 approved decisions 并应用到 request，然后按续接方向继续推进。
# =============================================================================
